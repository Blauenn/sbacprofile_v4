...
// Contexts providers //
import { StudentsContextProvider, useContext_Students } from '../../../contexts/Student.context';
// Contexts //
...
const Head_LeaveNotices = () => {
	...
	useEffect(() => {
		...
		const leaveNoticesInMajor = leaveNotices.result.filter((leaveNotice: LeaveNoticeInterface) => student_major_from_ID(leaveNotice.leave_notice_student_ID, students.result) === userInfo.profile_major && leaveNotice.leave_notice_teacher_status === 2);
